...
public class SecurityFeatureClassifier {

    private static final String TAG = "FeatureClassifier";

    /** Name of the model file stored in Assets. */
    private static final String MODEL_PATH = "converted_model_inception_resnet_v2_v4_quantized.tflite";
    ...
    public SecurityFeatureClassifier(Activity activity) throws IOException {
