 ...
 */
public class NoteDimensionArFragment extends ArFragment {


    private static final String TAG = NoteDimensionArFragment.class.getSimpleName();
    ...
    // matching.
    private static final String DEFAULT_IMAGE_NAME = "note.jpg";
    ...
    public NoteDimensionArFragment() {
...
//        View view = inflater.inflate(R.layout.fragment_note_dimension_ar, container, false);
